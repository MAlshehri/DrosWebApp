...
using DrosApp.ViewModels;
using AutoMapper;
using DAL.Models;
using DAL.Core.Interfaces;
using DrosApp.Authorization;
using DrosApp.Helpers;
using Microsoft.AspNetCore.JsonPatch;
using DAL.Core;
using IdentityServer4.AccessTokenValidation;

namespace DrosApp.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            if (!(await _authorizationService.AuthorizeAsync(this.User, id, AccountManagementOperations.Read))
                .Succeeded)
        ...
        public async Task<IActionResult> GetUserByUserName(string userName)
        {
            ...
            if (!(await _authorizationService.AuthorizeAsync(this.User, appUser?.Id ?? "",
        ...
        public async Task<IActionResult> UpdateUser(string id, [FromBody] UserEditViewModel user)
        {
            ...
            var manageUsersPolicy =
                _authorizationService.AuthorizeAsync(this.User, id, AccountManagementOperations.Update);
            var assignRolePolicy = _authorizationService.AuthorizeAsync(this.User,
                Tuple.Create(user.Roles, currentRoles), Authorization.Policies.AssignAllowedRolesPolicy);
        ...
        {
            if (!(await _authorizationService.AuthorizeAsync(this.User, id, AccountManagementOperations.Update))
                .Succeeded)
                return new ChallengeResult();
        ...
        {
            if (!(await _authorizationService.AuthorizeAsync(this.User, id, AccountManagementOperations.Delete))
                .Succeeded)
                return new ChallengeResult();
        ...
        public async Task<IActionResult> GetRoleById(string id)
        {
            ...
            if (!(await _authorizationService.AuthorizeAsync(this.User, appRole?.Name ?? "",
                Authorization.Policies.ViewRoleByRoleNamePolicy)).Succeeded)
                return new ChallengeResult();
        ...
        {
            if (!(await _authorizationService.AuthorizeAsync(this.User, name,
                Authorization.Policies.ViewRoleByRoleNamePolicy)).Succeeded)
                return new ChallengeResult();
